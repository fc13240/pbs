...
<div class="container">
  <div class="current-location" style="margin-top:0;"> 
  	<a href="<s:url value='/brand/index.html'/>">商标市场</a>> 
          ...
          <ul>
            <li>
	            <div style="position: relative;width:283px;height:283px;">   
					...
					<span style="position: absolute;font-family:Microsoft YaHei;font-size:33px;top: 100px;width:100%;left:0;z-index:1;text-align: center;">${brand.name}</span>
	            </div>
            </li>
          </ul>
        </div>
