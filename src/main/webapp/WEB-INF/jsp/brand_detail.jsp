...
<div class="container box-red-line">
  <div class="left-sec">
          ...
          <ul>
            <li>
	            <div style="position: relative;width:283px;height:283px;">   
					...
					<span style="position: absolute;font-family:Microsoft YaHei;font-size:33px;top: 100px;width:100%;left:75px;">${brand.name}</span>
	            </div>
            </li>
          </ul>
        </div>
    ...
    <table class="goods-tb pos-rlt" width="580" border="0" cellspacing="0" cellpadding="0">
       <tr>
       <td colspan="2">
       <span style="line-height: 44px;font-size:20px;collor:#000000;">${brand.name}</span> 
      ...
      <tr>
        <td colspan="2">商品列表：<span>${brand.scope }</span>
      </tr>
      
      <tr>
        <td colspan="2">类似群组：${brand.similarNo }</td>
      </tr>
...
<div class="container">
  <div class="left-sec">
    <div class="content-top1">
      <ul>
        <li class="on"><a href="javascript:void(0);">商标详情</a><i class="arrow arrowT"></i></li>
        <li><a href="javascript:void(0);">交易流程</a><i class="arrow arrowT"></i></li>
        <li><a href="javascript:void(0);">过户材料</a><i class="arrow arrowT"></i></li>
        <li><a href="javascript:void(0);">支付方式</a><i class="arrow arrowT"></i></li>
        <li class="title"><a href="#">↑&nbsp;${brand.name }</a><i class="arrow arrowT"></i></li>
      </ul>
    </div>
    ...
    <div class="list-item">
     ...
     <table class="list-item-material" cellspacing="0" cellpadding="0">
              ...
              <tr>
               ...
               <td>公司</td>
               <td>个人</td>
               <td rowspan="3">商标代理委托书<br>
                   转让申请书<br>
                   转让协议</td>
               <td rowspan="3">商标注册证<br>
                   商标转让公证书<br>
                   商标转让证明</td>
              </tr>
              <tr>
          ...
          <dd class="pic"> 
          	<a href="<s:url value='/brand/getbrandDetail.html'/>?brandId=<c:out value='${recommendBrand.id}'/>" target="_blank">
	   			<div style="position: relative;width:192px;height:154px;">   
					...
					<span style="position: absolute;font-family:Microsoft YaHei;font-size:20px;top: 60px;width:100%;left:55px;">${recommendBrand.name}</span>
	            </div>
          	</a> 
          </dd>
          <dt class="name"> 
