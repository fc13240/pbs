...
function gotoPage() {
	...
	var url = "<s:url value='/patent/getAlreadySalePatent.html'/>?currentPage=" + pageNo;
	
	<c:if test="${searchCondition!=null}">
	
		url="<s:url value='/patent/getSearchAlreadySalePatent.html'/>?page.currentPage=" + pageNo+"&${searchCondition}";
	</c:if>
