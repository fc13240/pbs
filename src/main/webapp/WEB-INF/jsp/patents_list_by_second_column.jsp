...
<html>
<head>
<title>${secondColumnName}列表</title>
...
<div class="header-box">
	...
	<div class="page-header">
		...
		<div class="phc-search Left" style="margin-left:200px;">
			<form id="JS_search_form" class="search-form" action="<s:url value='/patent/getSearchGoodListBySecondColumn.html'/>" method="post">	
				 <input type="hidden" name="page.currentPage" value="1" > 
				 <input type="hidden" name="secondColumnId" value="${secondColumnId }" > 
				 <input type="hidden" name="secondColumnName" value="${secondColumnName }" > 
...
<!--当前位置-->
<div class="container">
  <div class="current-location" style="font-family: Microsoft YaHei"> 当前分类:${secondColumnName }</div>
</div>
<!--当前位置 end-->
